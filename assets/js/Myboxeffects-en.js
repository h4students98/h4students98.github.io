...
codingProjects.addEventListener("click", function() {window.location.href = "Codinghome.php";});

var physicsProjects = document.getElementById("physics-projects");
physicsProjects.addEventListener("click", function() {window.location.href = "Physicshome.php";}); 

var otherProjects = document.getElementById("other-projects");
otherProjects.addEventListener("click", function() {window.location.href = "Otherhome.php";}); 
...
codingProjects.addEventListener("click", function() {
    window.location.href = "Codinghome.php";
});

physicsProjects.addEventListener("click", function() {
    window.location.href = "Physicshome.php";
});

otherProjects.addEventListener("click", function() {
    window.location.href = "Otherhome.php";
});