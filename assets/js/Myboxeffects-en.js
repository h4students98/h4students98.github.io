...
codingProjects.addEventListener("click", function() {window.location.href = "Codinghome.html";});

var physicsProjects = document.getElementById("physics-projects");
physicsProjects.addEventListener("click", function() {window.location.href = "Physicshome.html";}); 

var otherProjects = document.getElementById("other-projects");
otherProjects.addEventListener("click", function() {window.location.href = "Otherhome.html";}); 
...
codingProjects.addEventListener("click", function() {
    window.location.href = "Codinghome.html";
});

physicsProjects.addEventListener("click", function() {
    window.location.href = "Physicshome.html";
});

otherProjects.addEventListener("click", function() {
    window.location.href = "Otherhome.html";
});