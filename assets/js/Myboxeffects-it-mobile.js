...
codingProjects.addEventListener("click", function() {window.location.href = "Codinghome-it-mobile.php";});

var physicsProjects = document.getElementById("physics-projects");
physicsProjects.addEventListener("click", function() {window.location.href = "Physicshome-it-mobile.php";}); 

var otherProjects = document.getElementById("other-projects");
otherProjects.addEventListener("click", function() {window.location.href = "Otherhome-it-mobile.php";}); 
...
codingProjects.addEventListener("click", function() {
    window.location.href = "Codinghome-it-mobile.php";
});

physicsProjects.addEventListener("click", function() {
    window.location.href = "Physicshome-it-mobile.php";
});

otherProjects.addEventListener("click", function() {
    window.location.href = "Otherhome-it-mobile.php";
});