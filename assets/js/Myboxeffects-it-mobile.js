...
codingProjects.addEventListener("click", function() {window.location.href = "Codinghome-it-mobile.html";});

var physicsProjects = document.getElementById("physics-projects");
physicsProjects.addEventListener("click", function() {window.location.href = "Physicshome-it-mobile.html";}); 

var otherProjects = document.getElementById("other-projects");
otherProjects.addEventListener("click", function() {window.location.href = "Otherhome-it-mobile.html";}); 
...
codingProjects.addEventListener("click", function() {
    window.location.href = "Codinghome-it-mobile.html";
});

physicsProjects.addEventListener("click", function() {
    window.location.href = "Physicshome-it-mobile.html";
});

otherProjects.addEventListener("click", function() {
    window.location.href = "Otherhome-it-mobile.html";
});